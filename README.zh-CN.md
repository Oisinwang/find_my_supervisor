...
Find My Supervisor 是一个走 **skills route** 的产品化 agent 工作流。它不是网站、不是导师评价社区，也不是代发或自动化沟通工具。它的目标是帮助学生基于公开来源，筛选和比较潜在研究生导师，并输出一份可核查的导师 shortlist 报告和由学生自己控制的沟通准备材料。
...
- 哪些风险和未知项需要问导师或师兄师姐
- 下一步应该读哪些论文、准备哪些核查问题、怎么缩小 shortlist
...
如果要向同学、老师或技术用户介绍这个项目，建议把它讲成“导师尽调 skill”，而不是导师评价网、自动套磁工具或网站产品。
...
- 不编造论文、会议、学生去向或招生名额
- 不承诺录取概率
- 不发送或自动化任何消息；只帮助学生准备问题清单和个性化沟通草稿
